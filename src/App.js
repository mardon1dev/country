  ...
  return (
    <div className={`${toggleBackground ? `bg-[#202C36]`: `bg-[#FAFAFA]`} min-h-screen`}>
      ...
      <Modal modal={modal} setModal={setModal} handleModal={handleModal} toggleBackground={toggleBackground}>
        <form onSubmit={handleAddCountry} className={`min-w-[100px] flex sm:flex-row flex-col sm:items-start items-center justify-between gap-6 h-full`} autoComplete='off'>
            <label>
